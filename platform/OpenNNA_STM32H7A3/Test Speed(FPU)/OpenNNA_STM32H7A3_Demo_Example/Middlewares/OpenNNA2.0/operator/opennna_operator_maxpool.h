...
#ifndef CORE_OPENNNA_OPERATOR_MAXPOOL_H
#define CORE_OPENNNA_OPERATOR_MAXPOOL_H
...
typedef struct Layer_Para_MaxPool Layer_Para_MaxPool;

//算子
void OpenNNA_Operator_MaxPool(struct layer *Layers);

#endif //CORE_OPENNNA_OPERATOR_MAXPOOL_H

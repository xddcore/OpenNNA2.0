 ...
 * @LastEditTime: 2022-08-01 15:21:50
...
|DEMO|网络类型|M1 Pro|I5-9400F|I9-12900K|注释|
|:----:|:----:|:----:|:----:|:----:|:----:|
|示例算子推理|NULL|✅(333333)| | | |616|160|若此demo可以运行，则证明框架核心功能正常|
|Mnist手写数字识别|全连接神经网络|✅(2398;2755)| | ||
|Mnist手写数字识别|卷积神经网络(LeNet5)|✅(506;544)| | | |
|Mnist手写数字识别|卷积神经网络(OpenNNA-Paper)|✅(219;222)| | | |
|Mnist手写数字识别|卷积神经网络(AlexNet)|| | | ||||
|热成像传感器的手势识别|全连接神经网络| | | | | | |
|热成像传感器的手势识别|卷积神经网络| | | | | | |
|语音关键词识别|卷积神经网络| | | | | | |

...
STM32H7A3ZIT6Q(280Mhz, Cortex M7, 1.4MB SRAM, 2MB Flash, Free RTOS|STM32CubeIDE(-ofast))<br>
Note:在采用STM32进行构造OpenNNA Paper中的卷积网络时，构造+释放网络的时间约为0.015873s(63 fps)。
